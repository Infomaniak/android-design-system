...
val DefaultIconTokens = IconTokens(
  ...
  size2xl = IntermediateDefault.IconSize2xl,
  size3xl = IntermediateDefault.IconSize3xl,
  size4xl = IntermediateDefault.IconSize4xl,
  borderWidthSm = IntermediateDefault.IconBorderWidthSm,
  borderWidthMd = IntermediateDefault.IconBorderWidthMd,
)